...
An op-amp based analog signal generator that accepts a 24V DC input and produces a configurable 5V sine wave output. Also supports square + triangle waveform outputs.
